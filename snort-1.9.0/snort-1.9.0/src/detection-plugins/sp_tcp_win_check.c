...
/* $Id: sp_tcp_win_check.c,v 1.9 2002/05/13 20:14:07 chrisgreen Exp $ */
...
#ifdef DEBUG
    printf("Plugin: TcpWinCheckInit Initialized\n");
#endif
}
...
void TcpWinCheckInit(char *data, OptTreeNode *otn, int protocol)
{
    ...
    otn->ds_list[PLUGIN_TCP_WIN_CHECK] = (TcpWinData *) calloc(sizeof(TcpWinData), sizeof(char));
