...
/* $Id: snort.h,v 1.248 2002/10/02 01:55:05 chrisgreen Exp $ */
...
#endif  /* WIN32 */
    int promisc_flag;
    char decode_alert_flag; /* if decode.c alerts are going to be enabled */
