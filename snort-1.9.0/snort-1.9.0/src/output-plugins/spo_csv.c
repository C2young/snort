...
/* $Id: spo_csv.c,v 1.15 2002/06/26 12:29:07 chrisgreen Exp $ */
...
AlertCSVData *AlertCSVParseArgs(char *args)
{
    ...
    if(num_toks <= 1)
    {
        ErrorMessage("ERROR => You must supply at least TWO arguments for "
                "the CSV plugin...\n");
        FatalError("\t ... arguements of \"/path/to/output/file default\" "
                "as a minimum.\n");
    }
